...
class Codnitive_Pasargad_Helper_Data extends Mage_Payment_Helper_Data
{
    ...
    {
        return Mage::getStoreConfig(Codnitive_Pasargad_Model_Config::getNamespace() . 'chkfrq');
    }

    public function getLastCheck()
    {
        $namespace = Codnitive_Pasargad_Model_Config::EXTENSION_NAMESPACE;
