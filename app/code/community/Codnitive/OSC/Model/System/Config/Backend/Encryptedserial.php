...
class Codnitive_OSC_Model_System_Config_Backend_Encryptedserial extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        try {
            ...
            try {
                ...
                curl_setopt($ch, CURLOPT_URL, Mage::helper('osc')->getConUrl().'update/');
