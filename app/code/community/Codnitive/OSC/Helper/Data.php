...
class Codnitive_OSC_Helper_Data extends Mage_Core_Helper_Data
{
...
//            $this->_checkCert();
	...
	{
		return Mage::getStoreConfig(Codnitive_OSC_Model_Config::getNamespace() . 'chkfrq');
	}

	public function getLastCheck()
	{
		$namespace = Codnitive_OSC_Model_Config::EXTENSION_NAMESPACE;
